...
Uso: \
Crea un carpeta en tu computadora, ejecuta \ git init \ git remote add origin https://github.com/utnfrrodsw/desarrollo-de-software.git \ git pull origin main \ pnpm install.
