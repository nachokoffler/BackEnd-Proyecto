...
import { get_all, get_one, add, sanitizar_input_de_sentencia, remove, update} from "./sentencia.controller.js";
...
sentencia_router.put('/', verificar_special_token, sanitizar_input_de_sentencia, update)
