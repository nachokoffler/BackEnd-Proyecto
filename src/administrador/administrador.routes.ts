...
import { get_all, get_one, log_in_jwt, sanitizar_input_de_administrador, add, remove, completar_registro} from "./administrador.controller.js";
...
administrador_router.post('/completar-registro', completar_registro)
